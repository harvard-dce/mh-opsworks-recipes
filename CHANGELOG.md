...
* *REQUIRES MANUAL RECIPE RUN* *REQUIRES EDITS TO CLUSTER CONFIG*
  ...
  ```bash
	./bin/rake stack:commands:execute_recipes_on_layers layers="Admin,Engage,Utility,Storage,Analytics,Ganglia,Workers" recipes="oc-opsworks-recipes::enable-ubuntu-advantage-esm"
  ```
